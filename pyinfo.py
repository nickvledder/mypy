...
def styles():
    ...
    css +=  '.h{background:url(\'https://www.python.org/images/header-bg2.png\') repeat-x;font-weight:bold;color:#000}'
...
def section_title():
    html  = '<tr class="h"><td>'
    html +=  '<a href="http://python.org/"><img border="0" src="https://www.python.org/images/python-logo.gif"></a>'
